    ...
    <a href="#">
      ...
      <div class="px-4 py-3 w-72">
        ...
        <div class="flex items-center">
          ...
          <div onClick={() => addToCart(product)} class="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-bag-plus" viewBox="0 0 16 16">
